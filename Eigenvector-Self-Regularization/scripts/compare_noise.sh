...
python compare_settings.py \
  ...
  --experiments normal:alex_batch64_sgd_lr0.0001_epochs100 noise50:alex_batch64_sgd_lr0.0001_epochs100_noise50.0 noise100:alex_batch64_sgd_lr0.0001_epochs100_noise100 \
